...
final class LoginValidationTests: XCTestCase {
    ...
    func test_LoginValidation_emptyEmail_And_Password() {
        ...
        let viewModel = LoginViewModel(networkService: networkService, credential: credential)
    ...
    func test_LoginValidation_validEmail_And_ValidPassword() {
        ...
        let viewModel1 = LoginViewModel(networkService: networkService, credential: credential1)
